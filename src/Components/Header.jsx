      ...
      <div className="flex flex-col justify-center items-center lg:items-start md:flex-row relative -z-10 lg:justify-between  mb-16">
        <div className="lg:mt-16 lg:mr-10 pb-10 relative md:order-1 order-2">
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute -top-48 mr-16 -z-40 w-48 lg:w-64 lg:top-0 lg:-mr-8 xl:w-80 xl:top-28 xl:-mr-28"
          >
            <circle
              cx="199.5"
              cy="199.5"
          ...
          <img className="absolute  -bottom-28 lg:-bottom-48 xl:-bottom-72 left-10  " src="./Images/Header/plus.svg" alt="" />
        </div>
        ...
        <div className="lg:-ml-[43px] md:order-2 order-1 mt-20 lg:mt-0	">
          <div className="relative -mt-16 overflow-hidden">
            ...
            <img className="-mr-1 w-[300px] sm:w-[400px] lg:w-[600px] lg:ml-6 xl:w-[700px]" src="./Images/Header/bg-1.svg" alt="" />
            ...
            <img className="absolute w-[240px] sm:w-[320px] lg:w-[480px] lg:ml-6 xl:w-[560px] top-0 left-5  z-10" src="./Images/Header/bg-2.svg" alt="" />
            <img className="absolute top-24 mr-12 z-10 hidden  xl:block"  src="./Images/Header/circle-small.svg" alt=""/>
            <img className="absolute w-[80px] sm:w-24 sm:mr-20 lg:w-[140px] lg:mr-32 lg:mt-16 top-5 mr-11 z-10 xl:mr-36" src="./Images/Header/Frame3.svg" alt=""/>
