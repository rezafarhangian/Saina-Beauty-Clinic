...
export default function SidebarMobile({ setShowSidebar }) {
  ...
  const [openSubMenuBeautyServices, setOpenSubMenuBeautyServices] =
    useState(false);
        ...
        <ul className="p-2">
          ...
          <li className="p-2 mb-2 rounded">
            ...
            >
              ...
              <div
                className={`${
                  openSubMenuServices ? "rotate-180" : "rotate-0"
                } `}
              >
                <BsChevronUp />
              </div>
            ...
            <ul
              className={` ${
                openSubMenuServices ? "block" : "hidden"
              } bg-[#F9F9F9] mt-2 p-2 `}
            >
              <li>
                <div
              ...
              <li>
                <div
                  onClick={() => {
                    setOpenSubMenuLaserServices(!openSubMenuLaserServices);
                  }}
                  className="flex items-center justify-between"
                >
                  ...
                  <div
                    className={`${
                      openSubMenuLaserServices ? "rotate-180" : "rotate-0"
                    } `}
                  >
                    <BsChevronUp />
                  </div>
                ...
                <ul
                  className={`${
                    openSubMenuLaserServices ? "block" : "hidden"
                  } p-2`}
                >
                  <li className="text-[#858585] text-sm p-2">
                    <Link
                      to={"/services"}
                      state={{ category: "3", service: 11 }}
                    >
                      لیزر موهای زائد
                    </Link>
                  </li>
