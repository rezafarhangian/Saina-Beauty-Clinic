    ...
    <div className="container  ">
      ...
      <div className="bg-Saina relative -top-44 sm:-top-64 p-2 rounded-xl ">
        <div className="md:m-6 relative">
          <span className="text-[#C4A0E1] text-xs md:text-lg lg:text-2xl">
            فرم ثبت
          </span>
          <h2 className="text-white text-xl  md:text-5xl lg:text-7xl">
            رزرو نوبت
          </h2>
          <img
            className="absolute hidden lg:block -top-5 right-40"
            src="./Images/Reservation/Ellipse.png"
            alt="Ellipse"
          />
          <img
            className="absolute hidden lg:block -top-32 left-40 xl:left-96"
            src="./Images/Reservation/Frame.png"
            alt="Frame"
          />
        </div>
          ...
          <div className="mt-10 order-1 w-[272px] md:w-[300px] lg:w-[400px] m-auto">
            <form onSubmit={submitForm}>
              ...
              >
                ...
                <option value="لیزر موهای زائد صورت">
