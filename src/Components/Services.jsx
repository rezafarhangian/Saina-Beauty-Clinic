    ...
    <div className="mt-28 mb-28 container">
      <div className="text-center mb-10 relative ">
        <h2 className="text-3xl md:text-5xl">
         ...
         <img className="absolute hidden lg:block -right-10 top-28 xl:-right-12" src="./Images/Services/Frame.svg" alt="" />
      ...
      <div className="flex items-center justify-between lg:justify-around  overflow-x-scroll lg:overflow-x-hidden  lg:w-[800px] lg:m-auto py-8  h-96">
        <ServicesBox title={"مو"} src={"./Images/Services/hair.svg"}>
        ...
        <ServicesBox title={" زیبایی"} src={"./Images/Services/beauty.svg"} margin={"margin"}>
          <div className="text-white text-center mt-10 leading-7">
        ...
        <ServicesBox title={"لیزر"} src={"./Images/Services/laser.svg"}>
          <div className="text-white text-center mt-10 leading-7">
