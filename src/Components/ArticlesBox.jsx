...
export default function ArticlesBox({ title, desc, img, category }) {
  return (
    <div className="bg-white w-72 rounded-xl p-5 my-16 ">
      ...
      <div className="flex items-center justify-between ">
        <span className="bg-Saina text-white py-1 text-xs px-2 rounded-lg">{`${category === "educational" ? "مراقبتی" : category=== "Helpful" ? "مفید" : ""}`}</span>
        <div className="flex items-center justify-end  cursor-pointer text-Saina text-sm ">
